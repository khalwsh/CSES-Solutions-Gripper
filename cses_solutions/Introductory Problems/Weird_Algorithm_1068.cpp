...
Consider an algorithm that takes as input a positive integer nnn. If nnn is even, the algorithm divides it by two, and if nnn is odd, the algorithm multiplies it by three and adds one. The algorithm repeats this, until nnn is one. For example, the sequence for n=3n=3n=3 is as follows:
...
Your task is to simulate the execution of the algorithm for a given value of nnn.
Input
