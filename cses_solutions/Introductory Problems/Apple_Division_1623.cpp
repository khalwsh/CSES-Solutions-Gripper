...
/*--------------------------------------------------------------------------------------------------------------------*/
/*--------------------------------------------------------------------------------------------------------------------*/
int solve(int index,int total_sum,vector<int>&v,int sum){
    if(index==v.size()){
        return abs(total_sum-2*sum);
    }
    int res1=solve(index+1,total_sum,v,sum+v[index]);
    int res2=solve(index+1,total_sum,v,sum);
...
signed main() {
    ...
    for(auto &val:v)total_sum+=val;
    cout<<solve(0,total_sum,v,0);
}